	...
	FrmRoom(JDesktopPane jdp){
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				if(row==-1) {
					JOptionPane.showMessageDialog(FrmRoom.this, "No record selected");
					return;
				}
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				dc.executeOtherQuery("delete from Room where roomid="+RoomId);
				showTable();
			}
		});
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				FrmRoomSearch cf2=new FrmRoomSearch(FrmRoom.this);
				jdp.add(cf2);
				jdp.setComponentZOrder(cf2, 0);
				jdp.setComponentZOrder(FrmRoom.this, 1);
			}
