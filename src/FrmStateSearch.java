...
public class FrmStateSearch extends JInternalFrame {
	JLabel lblField,lblValue;
	JComboBox<String> jcbField;
	JTextField jtfValue;
	JButton btnSearch,btnClose;
	FrmStateSearch(FrmState frmState){
		super("State Search",true,true,true,true);
		...
		jcbField.addItem("stateid");
		jcbField.addItem("statename");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				frmState.condition=" where "+cname+" = '"+cvalue+"'";
				frmState.showTable();
				dispose();
			}
		});
