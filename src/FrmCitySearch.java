...
public class FrmCitySearch extends JInternalFrame {
	JLabel lblField,lblValue;
	JComboBox<String> jcbField;
	JTextField jtfValue;
	JButton btnSearch,btnClose;
	FrmCitySearch(FrmCity frmCity){
		...
		jcbField.addItem("cityid");
		jcbField.addItem("cityname");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				frmCity.condition=" where "+cname+" = '"+cvalue+"'";
				frmCity.showTable();
				dispose();
			}
		});
