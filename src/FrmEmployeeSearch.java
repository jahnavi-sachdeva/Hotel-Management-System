...
public class FrmEmployeeSearch extends JInternalFrame {
	JLabel lblField,lblValue;
	JComboBox<String> jcbField;
	JTextField jtfValue;
	JButton btnSearch,btnClose;
	FrmEmployeeSearch(FrmEmployee frmEmployee){
		super("Employee Search",true,true,true,true);
		...
		jcbField.addItem("eid");
		jcbField.addItem("ename");
		jcbField.addItem("address");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				frmEmployee.condition=" where "+cname+" = '"+cvalue+"'";
