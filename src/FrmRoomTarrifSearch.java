...
public class FrmRoomTarrifSearch extends JInternalFrame {
	JLabel lblField,lblValue;
	JComboBox<String> jcbField;
	JTextField jtfValue;
	JButton btnSearch,btnClose;
	FrmRoomTarrifSearch(FrmRoomTarrif frmRoomTarrif){
		super("Room Search",true,true,true,true);
		setLayout(new GridLayout(3,2,20,20));
		lblField=new JLabel("Field");
		lblField.setForeground(new Color(10,10,10));
		lblField.setFont(new Font(Font.SERIF,Font.ITALIC+Font.BOLD,20));

		lblValue=new JLabel("Value");
		lblValue.setForeground(new Color(10,10,10));
		lblValue.setFont(new Font(Font.SERIF,Font.ITALIC+Font.BOLD,20));

		jcbField=new JComboBox<>();
		jcbField.setForeground(new Color(255,0,0));
		jcbField.setFont(new Font(Font.SERIF,Font.ITALIC+Font.BOLD,18));

		jcbField.addItem("roomid");
		jcbField.addItem("roomnumber");
		jcbField.addItem("roomname");
		jcbField.addItem("catid");
		jcbField.addItem("rent");
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				frmRoomTarrif.condition=" where "+cname+" = '"+cvalue+"'";
				frmRoomTarrif.showTable();
				dispose();
			}
		});
